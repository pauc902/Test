...
const login = async (page) => {
  ...
  await page.fill('input[name="email"]', process.env.TEST_EMAIL || 'ibuzsfujugyiffvuqd@hthlm.com');
  await page.fill('input[name="password"]', process.env.TEST_PASSWORD || 'Password1066');
